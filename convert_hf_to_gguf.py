...
class TextModel(ModelBase):
    ...
    def get_vocab_base_pre(self, tokenizer) -> str:
        ...
        if chkhsh == "7dec86086fcc38b66b7bc1575a160ae21cf705be7718b9d5598190d7c12db76f":
            # ref: https://huggingface.co/UW/OLMo2-4B-SuperBPE-t180k
            res = "superbpe"
        ...
        if chkhsh == "d5f1dd6f980fec569fb218a81a7658ac45fc56b38c5a0adeb1c232fbe04ef5ec":
            # ref: https://huggingface.co/ByteDance-Seed/Seed-Coder-4B-Base
            res = "seed-coder"
...
class MistralModel(LlamaModel):
    ...
    def get_community_chat_template(
        ...
        if vocab.tokenizer.version == TokenizerVersion.v1:
            ...
            template_file = "Qwen-mistral-Devstral-Small-2507.jinja"
        else:
