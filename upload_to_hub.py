...
def upload_model_to_hub():
    ...
    if token is None:
        print("Hugging Face token not found. Please log in using 'huggingface-cli login' or 'hf auth login'.")
        return
    ...
    if username != repo_owner:
        print(f"Warning: You are logged in as '{username}', but the repository owner is '{repo_owner}'.")
        print("Please make sure you have the necessary permissions to upload to this repository.")

    print(f"Preparing to upload the contents of '{MODEL_DIR}' to '{HUGGING_FACE_REPO_ID}'...")
    ...
    try:
        ...
        print(f"Successfully uploaded the contents of '{MODEL_DIR}' to '{HUGGING_FACE_REPO_ID}'.")
    except Exception as e:
